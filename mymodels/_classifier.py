...
if __name__ == "__main__":
    # Simple demonstration of Classifiers class usage
    print("Classifiers class demonstration:")
    print("-" * 30)
    
    # Example 1: Basic usage
    model_name = "rf"  # Random Forest
    classifier = MyClassifiers(model_name, random_state=42)
    model_obj, param_space, static_params = classifier.get()
    ...
    cat_classifier = MyClassifiers("cat", random_state=42, cat_features=cat_features)
    _, _, cat_params = cat_classifier.get()
